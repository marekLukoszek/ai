...
def load_data_with_custom_image(width=28, height=28, verbose=True):
    ...
    # moj jpg
    custom_image = Image.open('samples/a_small.jpg')
    ...
    custom_label[0] = 1  #indeks to numer kolejności litery w alfabecie
...
def train(model, train_images, train_labels, callback=True, batch_size=256, epochs=2):
...
if __name__ == '__main__':
    ...
    my_new_model = tf.keras.models.load_model('bin/my_emnist_model.h5')
    train(my_new_model, train_images, train_labels, True, 3)
